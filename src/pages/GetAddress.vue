...
.row
  ...
  form.col.s12.content
    .input-field.col.s12
      input.validate(type="text" v-model='basicData.oldAddressOrOrg' placeholder='')
      label.active 原住址或单位
    .input-field.col.s12
      input.validate(type="text" v-model='basicData.oldResidenceUnit' placeholder='')
      label.active 原户口登记机关
    .input-field.col.s12
      input.validate(type="text" v-model='basicData.planAddressOrOrg' placeholder='')
      label.active 拟迁入地址或单位名称
    .input-field.col.s12
      input.validate(type="text" v-model='basicData.transferCause' placeholder='')
      label.active 迁入原因
    h6 随迁人员
    table
      thead
      ...
      div.modal-dialog(style='padding: 20px')
        div.modal-content
          ...
          div.modal-body
            div.form-group
              div.col-lg-10
                input(type="text" class="form-control" placeholder="姓名" v-model="child.transferName")
            div.form-group
              div.col-lg-10
